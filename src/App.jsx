...
const App = () => {
  ...
  const HomePage = () => (
    <div className="min-h-screen bg-zinc-900 text-gray-100 -mt-0">
      {/* Hero Section */}
      <div className="relative h-screen pt-0 flex items-center justify-center border-b border-zinc-800 overflow-hidden">
        {/* Background Image */}
        <div 
